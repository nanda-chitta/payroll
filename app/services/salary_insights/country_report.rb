module SalaryInsights
  class CountryReport
    def self.call(country:, job_title_id: nil)
      new(country:, job_title_id:).call
    end

    def initialize(country:, job_title_id: nil)
    ...
    def salary_distribution
      ...
      buckets.map do |label, lower, upper|
